...
//    MediaInfo MI;
//    String To_Display=MI.Option(__T("CharSet"), __T("UTF-8"));
...
//    To_Display += __T("\r\n\r\nOpen\r\n");
//    MI.Open(__T("/home/joshua/music/MyDearest.mp3"));
...
//    To_Display += __T("\r\n\r\nInform with Complete=XXX\r\n");
//    MI.Option(__T("Complete"), __T("2"));
//    To_Display += MI.Inform();
////    To_Display += __T("\r\n\r\nCustom Inform\r\n");
...
//    To_Display += __T("\r\n\r\n Duration0 =\r\n");
//    To_Display += MI.Get(Stream_General,0,__T("Stream/size"));
//    To_Display += __T("\r\n\r\n Duration1 =\r\n");
//    To_Display += MI.Get(Stream_General,1,__T("Duration"));
//    To_Display += __T("\r\n\r\n Duration2 =\r\n");
//    To_Display += MI.Get(Stream_General,2,__T("Duration"));
//    To_Display += __T("\r\n\r\n Duration3 =\r\n");
//    To_Display += MI.Get(Stream_General,3,__T("Duration"));
//    To_Display += __T("\r\n\r\nClose\r\n");
...
////    while (true)
////    {
////        _value = MI.Get(Stream_General, 0, i++, Info_Name);
////        _value = MI.Get(Stream_General,0,__T(_value));
////        if (_value == "")
////        {
////            break;
////        }
